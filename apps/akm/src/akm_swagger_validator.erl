-module(akm_swagger_validator).

-type param_rule() :: swag_server_apikeys_param_validator:param_rule().
-type schema_rule() :: swag_server_apikeys_schema_validator:schema_rule().
-type value() :: swag_server_apikeys:value().
-type param_context() :: swag_server_apikeys_param_validator:context().
-type schema_context() :: swag_server_apikeys_schema_validator:context().
...
-behaviour(swag_server_apikeys_custom_validator).
